...
export default function Favorites() {
  ...
  useEffect(() => {
    ...
    fetch(
      `${SB_URL}/rest/v1/catalogo_publico?destacado=eq.true&select=id,nombre,categoria,precio,precio_promo,unidad,venta_por,imagen_url&order=nombre&limit=8`,
  ...
  return (
    <section id="catalogo" className="pn-favs pn-card-sec">
      <div className="pn-favs-head">
        <div className="pn-favs-heading" data-reveal>
        ...
        <Link className="pn-btn pn-btn-ghost pn-btn-md pn-d" to="/catalogo" data-reveal style={{ '--i': 1 }}>
          ...
          return (
            ...
            >
              ...
              <div className="pn-fav-body">
                ...
                <h3 className="pn-card-name pn-card-name-clamp">
                  {p.nombreCorto
                    ? <><span className="pn-d">{p.nombre}</span><span className="pn-m">{p.nombreCorto}</span></>
                    : p.nombre}
                </h3>
                <div className="pn-fav-price-wrap">
